...
(async () => {
  ...
  await fs.writeFile("diaphragmatic-hernia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diaphragmatic-hernia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
